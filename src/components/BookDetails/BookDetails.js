      ...
      <div className="book-data">
        ...
        <div className="body-details">
          <div className="general-info">
            ...
            <p>
              Genre:{" "}
              <span className="span-details">{singleBook?.genre?.name}</span>
            </p>
          ...
          <div className="description">
            ...
            <p>
              ...
              the United States by Scholastic. In both countries, the release
              date was 8 July 2000. This was the first time a book in the series
              was published in both countries at the same time. The novel won a
              Hugo Award, the only Harry Potter novel to do so, in 2001. The
              book was adapted into a film, released worldwide on 18 November
              2005, and a video game by Electronic Arts.
            </p>
          </div>
        </div>
      </div>
